...
BOT_TOKEN = getenv("BOT_TOKEN", "5394395822:AAF5kCZn1343IsBYDDF3ebbvVbT1sPBjMTE")
BOT_NAME = getenv("BOT_NAME", "sunny")

API_ID = int(getenv("API_ID", "12190971"))
API_HASH = getenv("API_HASH", "cd1481752891b60818e9fd0ceac09848")
MONGO_DB_URL = getenv("MONGO_DB_URL", "mongodb+srv://Aman:Aman@cluster0.v8vph.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
OWNER_NAME = getenv("OWNER_NAME", "sunnybabuu")
OWNER_USERNAME = getenv("OWNER_USERNAME", "sunnybabuu")
ALIVE_NAME = getenv("ALIVE_NAME", "Zaid")
BOT_USERNAME = getenv("BOT_USERNAME", "sunnykmusic_bbbot")
OWNER_ID = getenv("OWNER_ID", "5646966699")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "all_competitive_music")
...
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "5646966699").split()))
